...
<div id="content" class="site-content" style="transform: none;">
    <div id="primary" class="content-area" style="float: left;">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <li><a href="/tag/${tag.tagId}/pn/1">首页</a></li>
                <c:if test="${pageInfo.hasPreviousPage}" >
                    <li>
                        <a href="/tag/${tag.tagId}/pn/${pageInfo.pageNum-1}" aria-label="Previous">
                ...
                <c:forEach items="${pageInfo.navigatepageNums}" var="page_Num">
                    ...
                    <c:if test="${page_Num!=pageInfo.pageNum}">
                        <li><a href="/tag/${tag.tagId}/pn/${page_Num}">${page_Num}</a></li>
                    </c:if>
                </c:forEach>
                <c:if test="${pageInfo.hasNextPage}" >
                    <li>
                        <a href="/tag/${tag.tagId}/pn/${pageInfo.pageNum+1}" aria-label="Next">
                            <span aria-hidden="true">下一页&raquo;</span>
                        </a>
                    </li>
                </c:if>
                <li><a href="/tag/${tag.tagId}/pn/${pageInfo.pages}">末页</a></li>
            </ul>
        </nav>
    </div>
    <%--右侧导航栏，基本信息等等--%>
